    ...
    <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-8">
            <AddToCartForm productId={product._id} stock={product.stock} />
          </div>

          <div className="mt-6 text-sm text-muted-foreground">
            Category:{' '}
            <Link href={`/products?category=${product.category.slug}`} className="font-medium text-foreground hover:text-primary hover:underline">
